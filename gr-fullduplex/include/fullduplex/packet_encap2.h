 ...
 */
void
packet_encap2::pilot_lts(gr_complex* pilot) {
...
void
packet_encap2::pilot_qpsk(gr_complex* pilot)
{
...
void
packet_encap2::pilot_symmetric(gr_complex* pilot)
{
...
void
packet_encap2::pilot_sync2(gr_complex* pilot)
{
...
void
packet_encap2::pilot_sync1(gr_complex* pilot)
{
...
void
packet_encap2::pilot_zero(gr_complex* pilot)
{
	for (int idx = 0; idx < 160; idx++) {
